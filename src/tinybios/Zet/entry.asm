...
post_start:				xor		ax, ax
						POSTCODE 010h								; PostCode = 10
...
ebda_post:              POSTCODE 012h								; PostCode = 12
                    ...
                    ;;  mov     ax, 0000010001000001B    ; where we setup the equipment list, see INT11 
						...
						;
						;mov		al, 0AFh				;; Enable IRQ 12 (Mouse), 14 (IDE)
...
int13_HD_Busy:			pop     es                      ;; Restore
                        pop     ds                      ;; Restore
                        xor		ah,ah
						sti
						ret	2						
						
int13_HD_IntComplete:	pop     es                      ;; Restore
                        pop     ds                      ;; Restore
                        xor		ah,ah
						iret		
;;--------------------------------------------------------------------------
...
;;--------------------------------------------------------------------------
                        ...
                        jmp     far ptr post_start      ;; Continue with regular POST
