...
Step 2.  There should be a file "zetbios_de0.dat" this is the shadow bios boot
         ...
         is that you are using in the BIOSROM.v module (the default is 
...
Step 7.  Your board should now have it's bios loaded into flash. Now you will
         ...
         "zetbios_de0.dat". That code will then copy the main BIOS from Flash
